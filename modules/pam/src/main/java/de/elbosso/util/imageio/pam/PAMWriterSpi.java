 ...
 * @author elbosso
 */
public class PAMWriterSpi extends javax.imageio.spi.ImageWriterSpi
{
	private final static org.apache.log4j.Logger CLASS_LOGGER = org.apache.log4j.Logger.getLogger(PAMWriterSpi.class);
	public PAMWriterSpi()
	{
		super("NetSys.IT",
			"0.1.0",
			...
			"de.elbosso.util.imageio.pam.PAMWriter",
			new java.lang.Class[]{javax.imageio.stream.ImageOutputStream.class},
			new java.lang.String[]{"de.elbosso.util.imageio.pam.PAMReaderSpi"},
			false,
			null,
			null,
			null,
	...
	{
		return new de.elbosso.util.imageio.pam.PAMWriter(this);
	}
